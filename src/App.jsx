    ...
    return (
        <div className="App">
            <animated.div style={headerAnimation} className="header">
                ...
                <p>Software Engineer, interested in product usability, front-end development, and design patterns.</p>
            </animated.div>
            <animated.div ref={ref} style={workAnimation} className="section">
                ...
                <animated.div {...project1Animation} className="sub-section">
                    ...
                    <p>Led the development of tax-filing portals across three Swiss cantons using React and Redux,
                        ...
                        taxes.</p>
                    <p>Each portal is adopted by the government as the official tax filing solution in the canton.</p>
                ...
                <animated.div {...project3Animation} className="sub-section">
                    ...
                    <p>Developed services for clinics, including a billing system, insurance claim system, benefitting
                ...
                <animated.div {...project4Animation} className="sub-section">
                    ...
                    <p>Helped a large digital transformation of a large british grocery store, transitioning features
